            ...
            <div class="col-lg-7 col-md-6">
                <div class="me-lg-5">
                    <img src="https://cdni.iconscout.com/illustration/premium/thumb/login-enter-the-metaverse-world-5830875-4857593.png"
                        class="img-fluid avatar w-75 avatar-sm d-block" alt="">
                </div>
            </div>
            <div class="col-lg-5 col-md-6">
                <div class="card shadow-none login-page bg-white rounded border-0">
                    <div class="card-body shadow-none">
                        <h4 class="card-title text-dark">REGISTER <i class="fal fa-user-plus"
                            ...
                            <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            ...
                                            <input type="email" class="form-control ps-5" id="register_name" placeholder="Name" required="">
                                        </div>
                                    </div>
                                </div>
                                <!--end col-->
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            ...
                                            <input type="email" class="form-control ps-5" id="register_email" placeholder="Email"
                                                name="email" required="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 mb-0">
                                    <div class="d-grid">
                                        <button type="button" id="regiser" class="btn btn-primary">Register</button>
                                    </div>
                                </div>
                                <!--end col-->
                                ...
                                <div class="col-12 text-center">
                                    <p class="mb-0 mt-3"><small class="text-dark me-2">Already have an account ?</small>
                                        <a href="index.php" class="text-dark fw-bold">login Now</a>
                                    </p>
                                </div>
                                <!--end col-->
                            </div>
